(function (global, factory) {
    ...
    /* src/Component.svelte generated by Svelte v3.18.1 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			img = element("img");
    			this.c = noop;
    			if (img.src !== (img_src_value = /*img_url*/ ctx[0])) attr(img, "src", img_src_value);
    			attr(img, "alt", "");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(0, img_url = attrs["image-url"]);
    		$$invalidate(1, link = attrs.link);
    	});
    ...
    class Component extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>.d-block{display:block}.w-100{display:block}</style>`;
    ...
    customElements.define("promotion-banner", Component);
